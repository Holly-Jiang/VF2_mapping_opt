...
public class App1 {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Path graphPath = Paths.get("E:\\github\\VF2\\data\\graphDB", "mygraphdb3.data");
        Path queryPath = Paths.get("E:\\github\\VF2\\data\\graphDB", "Ex2.my");
        Path outPath = Paths.get("E:\\github\\VF2\\data\\graphDB", "res_Ex2.my");
        Path outIniPath = Paths.get("E:\\github\\VF2\\data\\graphDB", "ini_map1.my");
        ...
        for (Graph queryGraph : querySet){
            queryCnt++;
            ArrayList<State> stateSet = vf2.matchGraphSetWithQuery1(graphSet, queryGraph,iniWriter);
            if (stateSet.isEmpty()){
